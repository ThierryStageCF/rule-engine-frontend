...
export default function SelectField({id, name, label, selectLabel, options, required = false, register, error, icon, disabled}: SelectFieldProps) {
    return (
        <div>
            {label &&
            ...
            <div className="relative">
                ...
                >
                    <option value="">
                        {selectLabel ? selectLabel : "Veuillez choisir une option"}
                    </option>
