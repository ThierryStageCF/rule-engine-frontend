...
const DASHED: Record<ButtonVariant, string> = {
    ...
    success: "border border-dashed border-success text-success hover:bg-success/10",
    warning: "border border-dashed border-warning text-warning hover:bg-warning/10",
